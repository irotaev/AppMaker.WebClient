...
export class FlexboxSettingsEditorComponent extends SettingsEditorComponent implements OnInit {
  ...
  ngOnInit() {
    this.position = (this.uiComponent.instance as DynamicComponent).el.nativeElement.style.position;
    this.justifyContent = this.uiComponent.instance.containerWrapperElementRef.nativeElement.style.justifyContent;
  }
